...
public class Main extends Application {
	...
	public static double probaMutation = 0.2;
	...
	public void start(Stage primaryStage) throws Exception {
		...
		while (testScore>scoreFinal) {
			...
			ArrayList<List50Polygons> CrossOver = p1.Doublecrossover(generationNouvelle);
			//System.out.println("cross over ");
	/*		for (int i = 0; i < CrossOver.size(); i++) { 
				  System.out.println("liste " + i + " "+CrossOver.get(i).score); }*/
			// System.out.println(" fin crossover");
			// System.out.println("fin mutation");
			ArrayList<List50Polygons> Mutation =p1.mutation(CrossOver);
			Mutation.sort(p1);
		...
		Scene scene = new Scene(picture, ConvexPolygon.max_X, ConvexPolygon.max_Y);// Stockage de l'image dans un fichier .png
